...
class Db:
    ...
    def default_data(self):
        usr = [
            (1, 'Пушкин Александр Сергеевич','+79487561238','pushkin@mail.ru', 75000),
            (2, 'Достоевский Федор Михайлович','+79181234589','dostoevskiy@mail.ru', 55000),
            (3, 'Толстой Лев Николаевич','+790075149621','tolstoy@mail.ru', 70000),
            (4, 'Чехов Александр Павлович','+792874596289','chehov@mail.ru', 50000),
            (5, 'Гоголь Николай Василевич','+79507955223','gogol@mail.ru', 100000)
        ]
